/*
Wojciech Ładyga -mx+dns
*/

// gcc -std=c99 -pedantic -Wall find_mx.c -c
// gcc -o mx_ladyga mx_ladyga.c find_mx.o -lresolv -std=c99 -pedantic -Wall
// example ./mx_ladyga a@uj.edu.pl a@gmail.com asdeee@interia.pl
// example2 ./mx_ladyga onet.pl  ala@gmail.com @yahoo.com
#include <stdio.h>
#include <string.h> 
#include <netdb.h>
#include <stdio.h>
