 ...
 * efekt.
 *
 * Pedantyczna uwaga: adresy IPv4 łącznie z końcowym INADDR_ANY są zapisane
 * w sieciowej kolejności bajtów, tak jak zawsze w przypadku struktur
 * przechowujących adresy dla gniazdek.
 *
